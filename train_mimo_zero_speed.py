...
from environments import EnvLoad3RLConstZeroSpeed, EnvLoad3RLZeroSpeed
...
if env_const:
    ...
    max_episodes = 200
    env = EnvLoad3RLConstZeroSpeed(sys_params=sys_params_dict)

else:
    max_episode_steps = 750
    max_episodes = 1000
    env = EnvLoad3RLZeroSpeed(sys_params=sys_params_dict)
...
config = {
    ...
    "env_name": "3-Phase RL Constant Reference" if env_const else "3-Phase RL Variable Reference",
}
# run = wandb.init(
#     project="sb3",
#     config=config,
...
if train:
    ...
    model.save("ddpg_EnvLoad3RLConstZeroSpeed" if env_const else "ddpg_EnvLoad3RLZeroSpeed")
if test:
    model = DDPG.load("ddpg_EnvLoad3RLConstZeroSpeed" if env_const else "ddpg_EnvLoad3RLZeroSpeed")
