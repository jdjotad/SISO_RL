...
from environments import EnvLoad3RLConst, EnvLoad3RL
...
sys_params_dict = {"dt": 1 / 10e3, "r": 1, "l": 1e-2, "vdc": 500, "we": 0}
if env_const:
    max_episode_steps = 500
    max_episodes = 200
    env = EnvLoad3RLConst(sys_params=sys_params_dict)
...
if train:
    ...
    model.save("ddpg_EnvLoad3RLConst" if env_const else "ddpg_EnvLoad3RL")
if test:
    model = DDPG.load("ddpg_EnvLoad3RLConst" if env_const else "ddpg_EnvLoad3RL")
